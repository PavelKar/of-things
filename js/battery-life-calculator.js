...
var powerlipo = function() { return calcpowerlipo(powerlipobruvalue, powerliponetvalue);};
...
var runtimedayshoursest = function() { return parseInt(runtimehoursest() % 24);};

var dothemath = function() {
  if( $("#timerun").val() && $("#timesleep").val() && $("#consumpactive").val() && $("#consumpsleep").val() && $("#powerlipobru").val() && $("#powerliponet").val() ) {
      getValues();
